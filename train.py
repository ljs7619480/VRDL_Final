...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/wheat.yaml', help='data.yaml path')
...
# python train.py --cache-images --single-cls --epochs 40 --data wheat.yaml --weights yolov5l.pt --multi-scale